...
## Costi
L'analisi dei costi è davvero semplice se si esclude il tempo personale dedicato allo sviluppo e il costo dell'hardware. Li ho eliminati entrabi perché totalmente soggettivi: il tempo influenza il tempo di sviluppo e senza fretta si arriva al risultato finale; per l'hardware basta un qualunque computer, persono un Raspberry Pi da poche decine di euro.
